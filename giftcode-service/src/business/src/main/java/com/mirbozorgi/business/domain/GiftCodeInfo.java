...
public class GiftCodeInfo {
  ...
  public GiftCodeInfo(String id, String name, String code, String gamePackageName,
      String env,
      String marketName, WalletChange walletChange, long creationDate, long expireDate,
      int maxUseCountGlobal, boolean isActive, int minClientVersion, int maxClientVersion,
      int minLevelPermission, int daysAfterInstall) {
    this.id = id;
    this.name = name;
    this.code = code;
