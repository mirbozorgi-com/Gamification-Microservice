...
import com.mirbozorgi.reactor.security.exception.AccessDeniedException;
...
public class JwtServiceImp implements JwtService {
  ...
  public String createToken(
    ...
    return doGenerateToken(
        ...
        expirationDate,
        secret,
        new JwtWrapper(new User(uuid, email, globalUniqueId, deviceId, role, sessionId)).getMap(),
        role
    );
