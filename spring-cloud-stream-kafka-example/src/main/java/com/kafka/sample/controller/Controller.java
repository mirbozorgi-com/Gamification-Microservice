...
import com.kafka.sample.domain.ChatMessage;
import com.kafka.sample.domain.KafkaMassageRequest;
import com.kafka.sample.service.impl.Producer;
...
public class Controller {
  ...
  @RequestMapping(value = "/complexType", method = RequestMethod.POST)
  ...
  public String publishHttpClient(@RequestBody KafkaMassageRequest payload) {
